namespace CguSalesforceConnector.Models
{
    ...
    public class SalesforceRecordTypeInfo
    {
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="CguSalesforceConnector.Models.SalesforceRecordTypeInfo"/> is available.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="CguSalesforceConnector.Models.SalesforceRecordTypeInfo"/> default
		/// record type mapping.
		/// </summary>
